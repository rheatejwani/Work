...
BPM appears to not have many discrepancies by decade. Valence appears to have decreased throughout time. The spread of speechiness appears to be increasing over time, as well as the number of outliers. 
...
No variables that we tested for in hit music have become less diverse over time, but only a few became more varied. These were acousticness, as demonstrated by our summary statistics for variance, and speechiness, as demonstrated by an increased spread over time by our box plots. 