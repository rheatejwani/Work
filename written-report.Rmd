...
multiple linear regression --> what other factors -- to verify or question
- 0 or 1 for foreign lang
...
clarify what var or variance is//context

```{r linear-model}
acousticness_model <- lm(var ~ Year, data=spotify_data)
  tidy(acousticness_model)
```
The linear equation for the model is $\widehat{Acousticness}= -5731.744 + 3.277 \times year$
