...
H0: The proportion of popular foreign language songs in the "Modern" time period is equal to the proportion of popular foreign language songs in the "Pre 90s" time period ($\rho_m = \rho_o$, where $\rho_m$ is the proportion of popular foreign language songs in the "Modern" time period and $\rho_o$ the proportion of popular foreign language songs in the "Pre 90s" time period)

Ha: The proportion of popular foreign language songs in the modern decades is greater than the proportion of popular foreign language songs in the "Pre 90s" time period ($\rho_m = \rho_o$, where $\rho_m$ is the proportion of popular foreign language songs in the "Modern" time period and $\rho_o$ the proportion of popular foreign language songs in the "Pre 90s" time period)
...
*Linear Model for nonpop songs:* $\widehat{sdAcousticness}= 25.858 + 0.059 \times yearSince1956$
...
2. Nonpop songs consistently have a larger standard deviation of acousticness than pop songs since it has a higher intercept. 
